...
constexpr int kAngleResolutionMX64  = 4096;
constexpr int kAngleResolutionMX106 = 4096;
...
constexpr double kRpmResolutionMX64  = 0.114;
constexpr double kRpmResolutionMX106 = 0.114;
...
inline int GetAngleResolution(Model model) {
  switch (model) {
    ...
    case Model::MX64:
      return kAngleResolutionMX64;
    case Model::MX106:
      return kAngleResolutionMX106;
    case Model::INVALID:
      break;
  }
  return 0;
...
inline double GetRpmResolution(Model model) {
  switch (model) {
    ...
    case Model::XC430:
      return kRpmResolutionXM430;
    case Model::MX64:
      return kRpmResolutionMX64;
    case Model::MX106:
      return kRpmResolutionMX106;
    case Model::INVALID:
      break;
  }
  return 0.0;
